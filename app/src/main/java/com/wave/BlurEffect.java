...
public class BlurEffect extends BaseEffect {
    ...
    private void scaleBitmap(Bitmap bmp) {
        mScaledBitmap = Bitmap.createScaledBitmap(bmp, bmp.getWidth() / 8, bmp.getWidth() / 8, true);
    ...
    // blur effect
    private static int DEFAULT_BLUR_RADIUS = 7;
